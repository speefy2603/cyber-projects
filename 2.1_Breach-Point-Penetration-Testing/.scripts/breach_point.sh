...
echo "==================================================="
echo ""
echo "Note: Metasploitable VM will be used for this project. It's IP is 192.168.152.144."
echo ""
...
echo "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
read -p "Enter a network to scan (e.g IP Address 123.45.6.789): " ip		#Requesting an input from user, in the form of an IP address
...
echo ""
read -p "Enter your choice (1-4): " attack
echo "--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
